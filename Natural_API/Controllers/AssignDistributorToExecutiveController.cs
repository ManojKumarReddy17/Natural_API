...
namespace Natural_API.Controllers
{
    ...
    public class AssignDistributorToExecutiveController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ResultRepsonse>> AssignDistributortoExecutive([FromBody] AssignDistributorToExecutiveResource distributorToExecutiveResources)
        {
            var AssignedResult =  new ResultRepsonse();
